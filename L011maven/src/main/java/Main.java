 ...
 * mvn package
 * java -cp ./target/L01.1-maven.jar Main
 * java -jar ./target/L01.1-maven.jar //java.lang.NoClassDefFoundError: com/google/common/collect/Lists
 * java -cp ./target/L01.1-maven.jar;C:\Users\Stormcoder\.m2\repository\com\google\guava\guava\25.1-jre\guava-25.1-jre.jar Main
 * <p>
 * To unzip the jar:
